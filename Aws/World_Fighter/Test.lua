...
local Codes = {
    ...
    "WOW500KVISITS!",
    "1KFAVORITESTHX!",    "EVENT2.5K!",
    "RELEASEPT2",    "THX3KLIKES!",
    "600KVISITSYAY!",    "700KVISITSINGAME",
    "2KFAVORITESTHANKYOU!",    "SPLENDID800KVISITS!",
    "900KVISITSTHANKYOU!",    "ALREADY1MVISITS!?",
    "THXFOR4KLIKES",    "THXFOR3KFAVORITES!",
    "RELEASEQOL",    "COOL1.2MVISITS!",
    "YAY5KLIKES!",    "8KCCUISAWESOME!",
    "UPDATE1",    "SRRY4DELAY",
    "9KPLAYERS",   "WOW10KCCU",
    "6KLIKESLOVU!",    "GOOD7KLIKES!",
    "AWESOME1.4MVISITS!",    "1.6MILLIONVISITS!",   "1.8MILLIONVISITSALREADY?!",
    "2MILLIONSSSVISITS!",    "AWESOME11KCCU",  "UPDATE1PT2",
    "SORRY4SHUTDOWN3",   "SRRY4UPDPROBLEMS",    "2MILLIONSSSVISITS",
}
        ...
        if Toggle_On then
            game:GetService("RunService").Heartbeat:Connect(function()
                ...
                for _, v in pairs(game:GetService("Workspace"):GetDescendants()) do
                    if v:IsA("Model") and v.Name == Selected_Global_Boss then
                        hrp.CFrame = v.PrimaryPart and v.PrimaryPart.CFrame or v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("HumanoidRootPart").CFrame
                        break
                    end
                end
            end)
