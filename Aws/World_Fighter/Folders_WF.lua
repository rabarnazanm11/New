...
local MyMax_Star_Open = game:GetService("Players").LocalPlayer.PlayerGui.UI.Frames.Profile.Background.Main.Stats["Max Star Open Stat"].Background.Main.Value.Text
