...
local JoinGoulDealy = GoulTab:Slider({
    Title = "Delay Auto Join ",
    Desc = "",
    
    IsTooltip = true,
    IsTextbox = true, 
    Step = 0.1,         -- Use 0.1 for float support
    Value = {
        Min = 0,
        Max = 3,
        Default = 1,
...
local GoulTab = Window:Tab({Title = "Car Boss",Icon = "bird",Locked = false,}) -- Icon is Optional
local BossCar = GoulTab:Toggle({
